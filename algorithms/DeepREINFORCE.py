                    ...
                    for name_agent in name_agent_list:
                        ...
                        if switch_env:
                            ...
                            if crash:
                                ...
                                # Train episode
                                train_REINFORCE(data_tuple[name_agent], algorithm_cfg.batch_size, agent[name_agent], algorithm_cfg.learning_rate, algorithm_cfg.input_size, algorithm_cfg.gamma, epi_num[name_agent])
                                c = agent[name_agent].network_model.get_vars()[16]
                                agent[name_agent].network_model.log_to_tensorboard(tag='v', group=name_agent, value=c[0], index=epi_num[name_agent])
                                data_tuple[name_agent]=[]
                                epi_num[name_agent]+=1
                                ret[name_agent] = 0
                                distance[name_agent] = 0
